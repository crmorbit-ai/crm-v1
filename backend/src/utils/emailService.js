      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p>CRM System © ${new Date().getFullYear()}</p>
            </div>
          </div>
        </body>
        </html>
...
const sendMeetingInvitation = async (meeting, attendeeEmails, organizerName) => {
  try {
    ...
    const mailOptions = {
      from: `"CRM Platform" <${process.env.EMAIL_FROM || process.env.SMTP_USER}>`,
      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p style="font-weight: 600; color: #1F2937;">CRM Platform</p>
      ...
      html: `
        ...
        <body>
          <div class="container">
            ...
            <div class="footer">
              <p style="color: #6B7280; font-size: 13px;">CRM Platform © ${new Date().getFullYear()}</p>
            </div>
          </div>
        </body>
        </html>
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <p style="font-size: 15px; color: #4B5563; line-height: 1.8;">
                We're excited to have you on board! Your account has been created and you can now access the CRM platform.
