  ...
  return (
    <>
      ...
      <nav className={`lp-nav${isScrolled ? ' scrolled' : ''}`}>
        <div className="lp-nav-inner">
          ...
          <div className="lp-nav-center">
            ...
            <button className="lp-nav-link" onClick={() => navigate('/case-studies')}>Case Studies</button>
          </div>
      ...
      <div className={`lp-drawer${mobileMenu ? ' open' : ''}`}>
        ...
        <button className="lp-drawer-link" onClick={() => goTo('/help')}>🛟 Support</button>
        <button className="lp-drawer-link" onClick={() => goTo('/case-studies')}>📊 Case Studies</button>
      ...
      {/* ── CASE STUDIES MOVED TO SEPARATE PAGE: /case-studies ── */}
