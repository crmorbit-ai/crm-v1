            ...
            <div>
              ...
              {customFieldDefinitions.length > 0 && lead.customFields && Object.keys(lead.customFields).length > 0 && (() => {
                ...
                return sections.map(sectionName => {
                  ...
                  const fieldsWithValues = groupedFields[sectionName].filter(field => lead.customFields[field.fieldName]);
                  ...
                  return (
                    <div key={sectionName} style={{ marginTop: '24px', paddingTop: '24px', borderTop: '1px solid #E5E7EB' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', background: '#F9FAFB', padding: '16px', borderRadius: '8px' }}>
                        {fieldsWithValues.map((field) => renderFieldValue(field, lead.customFields[field.fieldName]))}
                      </div>
                    </div>
                  );
                });
