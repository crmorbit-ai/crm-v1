...
const LocCountrySelect = ({ value, onChange }) => {
  ...
  @media(max-width:768px){
    .accounts-grid4,.accounts-grid3{grid-template-columns:repeat(2,1fr)!important;}
    .accounts-grid2{grid-template-columns:1fr!important;}
    .accounts-split{flex-direction:column!important;}
    .accounts-sidebar{width:100%!important;min-width:unset!important;max-width:unset!important;}
    .accounts-panel{width:100%!important;}
    .accounts-table{overflow-x:auto;-webkit-overflow-scrolling:touch;}
    .accounts-form-row{grid-template-columns:1fr!important;}
    .accounts-hide{display:none!important;}
  }
  @media(max-width:480px){
    .accounts-grid4,.accounts-grid3,.accounts-grid2{grid-template-columns:1fr!important;}
  }
`}</style>
            ...
            {loading ? (
              ...
              <>
                {viewMode === 'grid' ? (
                  ...
                  const ACCT_COL_MAP = {
                    accountName: { label:'Account Name', width:230,
                      render: a => {
